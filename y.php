...
<body class="w-100">
    <nav class="navbar navbar-expand-lg bg-dark shadow sticky-top">
        <div class="container">
            <a class="navbar-brand text-primary" href="#">TM Heart</a>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item me-2">
                        <a class="nav-link active text-white" href="#activity">
                            Activity
                        </a>
                    </li>
                    <li class="nav-item me-2">
                        <a class="nav-link active text-white" href="#overall">
                            Overall
                        </a>
                    </li>
                    <li class="nav-item me-2">
                        <a class="nav-link active text-white" href="#weight">
                            Weight
                        </a>
                    </li>
                </ul>
    ...
    <div id="activity" class="container my-5 text-center">
    ...
    <div class="w-100">
        ...
        <?php foreach ($data as $row): ?>
            <div class="overflow-y-auto mt-4" style="max-height: 65vh; max-width: 150%;">
                <?php $date = $row['Date']; ?>
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-2">
                                    ...
                                    ?>
                                    <button class="btn btn-sm btn-danger text-white float-end me-2"
                                    ...
                                    ?>
                                    <button class="btn btn-sm btn-info text-white float-end me-2"
                            ...
                            <script>
                                ...
                                function <?php echo $download_function_name; ?>() {
                                    ...
                                    const canvas = document.getElementById('myChart_<?php echo str_replace('-', '_', $date); ?>');
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
                        ...
                        <?php foreach ($data as $row): ?>
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    <div class="row text-center gap-1 mb-2">
                                        <div
                                ...
                                <div class="my-3 mx-3">
                                    <button class="btn btn-sm btn-danger disabled float-end">Request Edit</button>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
    ...
    <div id="overall" class="container my-5 text-center">
        <h1>Overall user report</h1>
    </div>
    <div class="container-fluid mt-3">
        <div class="row">
            <div class="col-lg-6 col-md-10 col-sm-12 mb-1">
                <div class="card">
                    <div class="card-title text-center py-2 bg-primary text-white rounded h6">Highs vs Time</div>
                    <div class="card-body">
                        <?php
                        $table_name = "user_{$id}_hb";
                        $sql = "SELECT MAX(HB) AS highest_hb, DATE(Date) AS hb_date FROM $table_name WHERE Date BETWEEN '$start_date' AND '$end_date' GROUP BY DATE(Date)";
                        $result = $conn->query($sql);
                        $data = $result->fetch_all(MYSQLI_ASSOC);
                        ...
                        <div class="mt-2">
                            <button class="btn btn-sm btn-danger text-white float-end me-2" onclick="download()">
                                <i class="bi bi-download"></i>
                            </button>
            ...
            <div class="col-lg-6 col-md-10 col-sm-12 mb-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php
                        $table_name = "user_{$id}_hb";
                        $sql = "SELECT MIN(HB) AS lowest_hb, DATE(Date) AS hb_date FROM $table_name WHERE Date BETWEEN '$start_date' AND '$end_date' GROUP BY DATE(Date)";
                        $result = $conn->query($sql);
                        $data = $result->fetch_all(MYSQLI_ASSOC);
        ...
        <div class="col-lg-6 col-md-10 col-sm-12 mb-1">
            <div class="card">
                ...
                <div class="card-body">
                    <?php
                    $table_name = "user_{$id}_hb";
                    $sql = "SELECT COUNT(*) AS high_count, DATE(time) AS hb_date FROM $table_name WHERE status = 'HIGH' AND time BETWEEN '$start_date' AND '$end_date' GROUP BY DATE(time)";
                    $result = $conn->query($sql);
                    $data = $result->fetch_all(MYSQLI_ASSOC);
        ...
        <div class="col-lg-6 col-md-10 col-sm-12 mb-1">
            <div class="card">
                ...
                <div class="card-body">
                    <?php
                    $table_name = "user_{$id}_hb";
                    $sql = "SELECT COUNT(*) AS low_count, DATE(time) AS hb_date FROM $table_name WHERE status = 'LOW' AND time BETWEEN '$start_date' AND '$end_date' GROUP BY DATE(time)";
                    $result = $conn->query($sql);
                    $data = $result->fetch_all(MYSQLI_ASSOC);
        ...
        <div class="col-lg-6 col-md-10 col-sm-12 mb-1">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    $sql = "SELECT Drop1m, DATE(time) AS hr_time FROM $table_name WHERE time BETWEEN '$start_date' AND '$end_date'";
                    $result = $conn->query($sql);
                    $data = $result->fetch_all(MYSQLI_ASSOC);
        ...
        <div class="col-lg-6 col-md-10 col-sm-12 mb-1">
            <div class="card">
                ...
                <div class="card-body">
                    <?php
                    $table_name = "user_{$id}_hr";
                    $sql = "SELECT Drop2m, DATE(time) AS hr_time FROM $table_name WHERE time BETWEEN '$start_date' AND '$end_date'";
                    $result = $conn->query($sql);
                    $data = $result->fetch_all(MYSQLI_ASSOC);
        ...
        <div class="col-lg-10 col-md-10 col-sm-12 mb-1 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <?php
                    $table_name = "user_{$id}_hr";
                    $sql = "SELECT RecTime, DATE(time) AS hr_time FROM $table_name WHERE time BETWEEN '$start_date' AND '$end_date'";
                    $result = $conn->query($sql);
                    $data = $result->fetch_all(MYSQLI_ASSOC);
    ...
    <div id="weight" class="container mt-5 mb-3">
        ...
        <div class="col-lg-10 col-md-10 col-sm-12 mb-1 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    $sql = "SELECT Weight, DATE(time) AS weight_time FROM $table_name WHERE time BETWEEN '$start_date' AND '$end_date'";
                    $result = $conn->query($sql);
                    $data = $result->fetch_all(MYSQLI_ASSOC);
